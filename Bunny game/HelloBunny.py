...
keys = [False, False, False, False] # The keys array keeps track of the keys being pressed in the following order: WASD. Each item in the array corresponds to one key – the first to W, the second to A and so on.
playerpos=[100,100]
acc=[0,0]
arrows=[]
badtimer=100
